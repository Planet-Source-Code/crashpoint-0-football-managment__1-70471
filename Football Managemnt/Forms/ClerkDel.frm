...
Private Sub cmdDelete_Click()
    ...
    CUsername = adoAdDel.Recordset.Fields("Username")
    CPass = adoAdDel.Recordset.Fields("Password")

    If txtPass.Text = tempPass Then
        
        If adoAdDel.Recordset.RecordCount = 0 Then
            Me.Hide
            MsgBox "There Are No Clerk Profiles Available. " & vbCrLf & _
                    " The System Will Be Logout." & vbCrLf + vbCrLf & _
                    " Please Create A New Clerk Profile To Access The System", _
        ...
        If UCase(txtAdminId.Text) = UCase(tempUser) Then
            Me.Hide
            MsgBox "The Clerk Profile To Be Deleted In Currently Being Used." & _
            ...
            Exit Sub
        Else
            If MsgBox("The Clerk Profile Will Be Deleted !!!" & vbCrLf & _
...
Private Sub cmdSearch_Click()
    ...
    On Error GoTo noData
        ...
        CName = adoAdDel.Recordset.Fields("Name")
        CId = adoAdDel.Recordset.Fields("ID_No")
        CTel = adoAdDel.Recordset.Fields("Telphone")
        ...
        lbladname.Caption = CName
        lbladDes.Caption = CId
        lbladCon.Caption = CTel
...
noData:
        ...
        lblErr.Visible = True
        lblErr.Caption = "The Clerk Profile No Exist !!!" & _
                            vbCrLf & " Please Enter A Valid Clerk Id... "
        Timer1.Enabled = True
        lbladname.Caption = ""
        lbladDes.Caption = ""
        lbladCon.Caption = ""
