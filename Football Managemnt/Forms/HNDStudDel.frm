...
Begin VB.Form HNDStudDel 
   BackColor       =   &H80000009&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "  :. Delete Club Information"
   ClientHeight    =   4650
   ClientLeft      =   45
   ClientTop       =   210
   ClientWidth     =   6300
        ...
        APass = adoAdmin.Recordset.Fields("Password")
            ...
            If txtAdPass.Text = APass Then
                ...
                If adostPer.Recordset.RecordCount = 0 Then
                    MsgBox "There is no Club's Records Available", vbInformation, "SysMan"
                    Unload Me
                    Exit Sub
                End If
...
Private Sub cmdSearch_Click()
    ...
    On Error GoTo noData
        ...
        If adostPer.Recordset.RecordCount = 0 Then
            MsgBox "There is no Club's record found in database", vbInformation, "SysMan"
            Exit Sub
        End If
        
            adostPer.Refresh
                
            adostPer.Recordset.Find ("Club_Name = '" & Trim(txtSearchId.Text) & "'")
            
            On Error Resume Next
            
                CMName = adostPer.Recordset.Fields("Manager")
                CCName = adostPer.Recordset.Fields("Club_Name")
                CFound = adostPer.Recordset.Fields("Founded")
                CLea = adostPer.Recordset.Fields("League")
                CPic = adostPer.Recordset.Fields("Logo")
                       
                    lblmes.Visible = True
                    lblmes.Caption = "Found !!!"
                    lblstuName.Visible = True
                    lblstuName.Caption = CCName
                    lblStuIc.Visible = True
                    lblStuIc.Caption = CMName
                    lblstuCo.Visible = True
                    lblstuCo.Caption = CLea
