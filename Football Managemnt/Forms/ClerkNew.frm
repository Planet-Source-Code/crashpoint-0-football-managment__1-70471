...
Begin VB.Form ClerkNew 
   BackColor       =   &H80000009&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "  :. New Clerk Profile - Football Management System"
   ClientHeight    =   7095
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   5070
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H80000009&
      Caption         =   "Clerk Security Settings"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   9.75
         Charset         =   0
   ...
   Begin MSComDlg.CommonDialog dlgCommon 
      ...
      _Version        =   393216
   End
   Begin MSAdodcLib.Adodc AdoClerk 
      Height          =   330
      Left            =   360
      Top             =   7440
      Width           =   1215
...
On Error GoTo ErrHandler 'handles the unwanted / unexpected errors
    ...
    If Trim(txtAdminPass.Text) = Trim(txtPassConfirm.Text) Then
        ...
        AdoClerk.Refresh
        AdoClerk.Recordset.AddNew
    
        With AdoClerk.Recordset
        ...
        End With
        AdoClerk.Recordset.Update
        
        AdoClerk.Refresh
     
        
        AdoClerk.Recordset.MoveFirst 'show error if no data entered
        ...
        If MsgBox("Clerk Profile Succesfully Entered." & vbCrLf & _
