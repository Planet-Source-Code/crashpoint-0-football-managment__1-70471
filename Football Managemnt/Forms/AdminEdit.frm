...
Private Sub cmdSearch_Click()
    ...
    On Error GoTo noRecord
        ...
        Exit Sub
noRecord:
        MsgBox "The admin profile could not be found.", vbOKOnly + vbExclamation, "SysMan"
...
Private Sub cmdUpdate_Click()
    ...
    If MsgBox("The Admin Profile Will Be Updated.. Proceed ?", vbOKCancel + vbQuestion, "SysMan") = vbOK Then
